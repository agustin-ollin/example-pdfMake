      ...
      content: [
    ...
    
        {
          ...
          stack: [
                    ...
                    { text: 'Universidad Autónoma "Benito Júarez" de Oaxaca\nSecretaría de Finanzas', style: 'normal' },
                    { text: 'Av. Universidad s/n. Ex-Hacienda de Cinco Señores\nTel. 951-5163492', style: 'normal' },
                 ...
                 
                {
                  ...
                  stack: [
                    { text: `FOLIO UNICO \nDE ADMISION: ${data.singleAdmissionSheet}`, style: 'titulo', alignment: 'center' },
                              {
          image: sep,
          fit: [100, 100],
           alignment: 'center',
              ...
              [
                { colSpan: 3, text: `FECHA LIMITE DE PAGO: ${data.paydayLimit}`, 
                style: 'subtitulo', 
                alignment: 'left' , 
                border: [true, false, true,false]},
              ],
              [
                { colSpan: 3, text: `NOMBRE DEL ASPIRANTE: ${data.applicantsName}`, 
                style: 'normal',
                border: [true, true, true,false]
                }
              ],
               [
                { colSpan: 1, text: `CURP: ${data.CURP}`, 
                style: 'normal',
              ...
              [
                { colSpan: 3, text: `CARRERA: ${data.careers}`, 
                style: 'normal',
                 border: [true, false, true,false]
                },
              ],
              [
                { colSpan: 3, text: `ESCUELA: ${data.school}`, 
                style: 'normal',
                border: [true, false, true,true]},
              ],
                [
                 { text: '',border: [true, false, false,false]},
                { text: 'Concepto', style: 'tituloF_pago',
                alignment: 'right',
                 border: [false, false, false,false]},
                { text: 'Importe ($)', 
                style: 'tituloF_pago', 
             ...
             { text: '',border: [true, false, false,false]},
              ...
              [
                { colSpan: 3, text: 'Puede realizar su pago en cualquiera de las entidades bancarias', 
                style: 'normal',
                border: [true, true, true,false],
                alignment: 'center'
                },
              ...
              [
                { colSpan: 3, text: 'Pagos via ventanilla', 
                style: 'subtitulo',
                border: [true, false, true, false],
                alignment: 'center'
                },
